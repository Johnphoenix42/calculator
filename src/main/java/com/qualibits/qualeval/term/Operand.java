...
public class Operand implements Term {
    ...
    /**
     * Used to create Operands that can be seen as constants
     * @param val the actual value in number that the operand object resolves to
     * @param denotation The mathematical denotation or symbol for the constant e.g ⫪, e as defined
     *                   in ButtonName
     */
